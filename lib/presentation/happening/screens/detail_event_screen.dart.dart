...
class ScreenEventDetail extends StatelessWidget {
  const ScreenEventDetail({super.key, required this.eventId});
                        ...
                        children: [
                          BlocBuilder<HappeningDetailCubit,
                            ...
                            builder: (context, stateX) {
                              final isRegistered = stateX.maybeWhen(
                                orElse: () => false,
                                success: (model) => model.isRegistered,
                              );
                              return stateX.isError || stateX.isLoading
                                  ? const SizedBox.shrink()
                                  : BlocBuilder<EventRegisterCubit,
                                      EventRegisterState>(
                                      builder: (context, state) {
                                        return Expanded(
