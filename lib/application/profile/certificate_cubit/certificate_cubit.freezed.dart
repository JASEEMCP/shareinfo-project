...
mixin _$CertificateState {
  ...
  CertificateModel get userModel => throw _privateConstructorUsedError;
...
class __$$EducationStateImplCopyWithImpl<$Res>
    extends _$CertificateStateCopyWithImpl<$Res, _$EducationStateImpl>
...
class _$EducationStateImpl implements _EducationState {
  ...
  @override
  final CertificateModel userModel;
  @override
  final bool isSaving;
  @override
  final bool isError;
  ...
  @override
  String toString() {
    return 'CertificateState(isLoading: $isLoading, userModel: $userModel, isSaving: $isSaving, isError: $isError, error: $error, isSuccess: $isSuccess, saveSuccess: $saveSuccess, deleteSuccess: $deleteSuccess)';
  }
...
abstract class _EducationState implements CertificateState {
  const factory _EducationState(
      {required final bool isLoading,
      required final CertificateModel userModel,
  ...
  bool get isLoading;
  @override
  CertificateModel get userModel;
  @override
  bool get isSaving;
  @override
  bool get isError;
