...
mixin _$LanguageState {
  ...
  LanguageSet get userModel => throw _privateConstructorUsedError;
...
class _$LanguageStateImpl implements _LanguageState {
  ...
  @override
  String toString() {
    return 'LanguageState(isLoading: $isLoading, userModel: $userModel, isSaving: $isSaving, isError: $isError, error: $error, isSuccess: $isSuccess, saveSuccess: $saveSuccess, deleteSuccess: $deleteSuccess)';
  }
...
abstract class _LanguageState implements LanguageState {
  const factory _LanguageState(
      ...
      required final LanguageSet userModel,
      required final bool isSaving,
      required final bool isError,
      required final MainFailure? error,
      required final bool isSuccess,
      required final bool saveSuccess,
      required final bool deleteSuccess}) = _$LanguageStateImpl;

  @override
  bool get isLoading;
  @override
  LanguageSet get userModel;
  @override
  bool get isSaving;
  @override
  bool get isError;
