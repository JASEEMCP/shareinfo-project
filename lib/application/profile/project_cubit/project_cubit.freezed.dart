...
mixin _$ProjectState {
  ...
  ProjectModel get userModel => throw _privateConstructorUsedError;
...
class __$$EducationStateImplCopyWithImpl<$Res>
    extends _$ProjectStateCopyWithImpl<$Res, _$EducationStateImpl>
...
class _$EducationStateImpl implements _EducationState {
  ...
  @override
  String toString() {
    return 'ProjectState(isLoading: $isLoading, userModel: $userModel, isSaving: $isSaving, isError: $isError, error: $error, isSuccess: $isSuccess, saveSuccess: $saveSuccess, deleteSuccess: $deleteSuccess)';
  }
...
abstract class _EducationState implements ProjectState {
  const factory _EducationState(
      {required final bool isLoading,
      required final ProjectModel userModel,
